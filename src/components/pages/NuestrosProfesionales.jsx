    ...
    <div className="page__nosotros">
      ...
      <div className='especialidad__content'>
        ...
        <p className='nosotros__paragraph'>
          CIMO SALUD cuenta con un staff de profesionales especializados para dar
          una atencion vangardista y con un criterio clinico de basta experiencia en el
          sector publico y privado.
        </p>

        <p className='nosotros__paragraph'>
          Cada uno de nuestros profesionales tiene su respectiva inscripcion en la
          superintendencia de salud, asi como especialidades, diplomados, cursos de
          continuidad y otros que permitiran darte mas confort y satisfaccion desde la
          evaluacion inicial hasta culminar el tratamiento que deseas iniciar.
        </p>
