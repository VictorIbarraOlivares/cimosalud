        ...
        <Carousel fade indicators={false}>
          <Carousel.Item>
            <img
              ...
              src="/images/consulta/image_1.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_2.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_3.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_4.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_5.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_6.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_7.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_8.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="carousel__image"
              src="/images/consulta/image_9.jpeg?text=First slide&bg=373940"
              alt="First slide"
            />
          </Carousel.Item>
        </Carousel>
